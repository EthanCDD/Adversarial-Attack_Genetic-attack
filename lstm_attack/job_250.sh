...
# Set the name of the job. LT: lstm transfer
#$ -N defense_250_150
...
python train_250.py --nlayer=1 --max_len=150 --bidirection=False --data=imdb --sample_size=1500 --test_size=1000 --use_lm=True
