...
# Set the name of the job.  DA:DEFENSE ATTACK
#$ -N DA_150_150 
...
cd /lustre/scratch/scratch/ucabdc3/lstm_attack
...
python defense_attack_150.py --nlayer=1 --max_len=150 --bidirection=False --data=imdb --sample_size=1500 --test_size=1000 --use_lm=True
