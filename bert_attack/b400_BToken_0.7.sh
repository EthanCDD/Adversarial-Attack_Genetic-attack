...
python train_400.py --freeze=true --nlayer=1 --data=imdb --kept_prob_dropout=0.7 --epoches=50 --learning_rate=0.001 --bidirection=False --tokenizer=bert --save_path=/lustre/scratch/scratch/ucabdc3/bert_lstm_attack/model_params
