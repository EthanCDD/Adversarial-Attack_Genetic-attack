...
python transfer_stop_100.py --nlayer=1 --data=imdb --sample_size=2000 --test_size=1000 --tokenizer=bert --file_path=/lustre/scratch/scratch/ucabdc3/bert_lstm_attack
